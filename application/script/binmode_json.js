...
(function() {
  ...
  function IRtobinjson_process(Data) {
    ...
    //        "00"
    //      ],
    //      "Description": "create_timer+"
    //    }
    //  ]
    //};
    //JsonOut.push(IntedBlock);
    //const Inted2Block = {
    //  "nMode": "000A",
    //  "CmdCnt": "0001",
    //  "TempGrp": "timer",
    ...
    //        "01"
    //      ],
    //      "Description": "procedures_callnoreturn+"
    //    }
    //  ]
    //};
    //JsonOut.push(Inted2Block);
    let group_num = 769; // 770 的 16進位是 0302，用來配發自定義函式的群組 ID
    let subBlock = [];
